  ...
  return (
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {/* Animated Gradient Background (id=6) */}
        {id === 6 && (
          <BackgroundGradientAnimation>
            <div className="absolute z-50 inset-0 flex items-center justify-center text-white font-bold px-4 pointer-events-none text-3xl md:text-4xl lg:text-7xl"></div>
          </BackgroundGradientAnimation>
        )}
